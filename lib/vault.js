...
const INTERNSHIP_DIR = "20 - Areas/Internship";

/** Save an audio recording (Buffer) into the vault's Internship/Recordings folder. */
export function saveInternshipRecording(name, buffer) {
  const dir = vpath(INTERNSHIP_DIR, "Recordings");
  fs.mkdirSync(dir, { recursive: true });
